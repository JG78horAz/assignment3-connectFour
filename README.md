[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/v3IzwCl_)
TCD3 - Assignment 3
===================
...
1. **Build**  
      Automatically build your web application
2. **Test**  
      Run all tests
3. **Package**  
      Create a web application archive (*.war) file to deploy the application
4. **Deploy**  
...
your machine by configuring Tomcat support in the IntelliJ run configuration of the project. Verify and document that your
application and all tests work as expected.
